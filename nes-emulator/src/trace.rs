use std::{ops::{Index, IndexMut, RangeFrom}, slice::SliceIndex};
...
pub enum TraceEvent {
    ...
    /// a 16bit dot.
    PpuCpuLineSync { cpu_clk: u64, ppu_clk: u64, line: u16 },
    ...
    CpuDmaRead { clk_lower: u8, addr: u16, value: u8 },
    CpuDmaWrite { clk_lower: u8, addr: u16, value: u8 },

    PpuRead { dot: u16, addr: u16, value: u8 },
    PpuWrite { dot: u16, addr: u16, value: u8 },
    PpuReadPalette { dot: u16, off: u8, value: u8 },
    PpuReadOam { dot: u16, off: u8, value: u8 },
    PpuWriteOam { dot: u16, off: u8, value: u8 },
