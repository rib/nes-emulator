...
use nes_emulator::{apu::channel::square_channel::SquareChannel, nes::Nes};
...
impl ApuView {
    ...
    fn draw_square_channel_props(
        ...
        egui::Grid::new(props_id_src).show(ui, |ui| {
            ...
            if ui
                .add(egui::DragValue::new(&mut period).clamp_range(0..=(1 << 11)))
                .changed()
            {
            ...
            if ui
                .add(egui::DragValue::new(&mut timer).clamp_range(0..=period))
                .changed()
            {
                    ...
                    .horizontal(|mut strip| {
                        ...
                        strip.cell(|ui| {
                            ui.vertical(|ui| {
                                ...
                                //ui.heading("Square 1");
                                ui.toggle_value(
                                    &mut nes.system_mut().apu.mixer.square1_muted,
                                    "Mute",
                                );
                                self.draw_square_channel_props(
                                    ...
                                    ui,
                                    &mut nes.system_mut().apu.square_channel1,
                                );
                            });
                        });
                        ...
                        strip.cell(|ui| {
                            ...
                            ui.vertical(|ui| {
                                ...
                                //ui.heading("Square 1");
                                ui.toggle_value(
                                    &mut nes.system_mut().apu.mixer.square2_muted,
                                    "Mute",
                                );
                                self.draw_square_channel_props(
                                    "apu_square2_props",
                                    ...
                                    ui,
                                    &mut nes.system_mut().apu.square_channel2,
                                );
                            });
                        });
                        ...
                        strip.cell(|ui| {
                            ...
                            ui.vertical(|ui| {
                                ui.heading("Triangle");
                                ui.toggle_value(
                                    &mut nes.system_mut().apu.mixer.triangle_muted,
                                    "Mute",
                                );
                                let mut enabled = nes
                                    .system_mut()
                                ...
                                egui::Grid::new("apu_triangle_props").show(ui, |ui| {
                                    ...
                                    ui.label("Frequency");
                                    let mut freq =
                                        nes.system_mut().apu.triangle_channel.frequency();
                                    if ui.add(egui::DragValue::new(&mut freq)).changed() {
                        ...
                        strip.cell(|ui| {
                            ...
                            ui.vertical(|ui| {
                                ui.heading("Noise");
                                ui.toggle_value(
                                    &mut nes.system_mut().apu.mixer.noise_muted,
                                    "Mute",
                                );
                                let mut enabled =
                                    nes.system_mut().apu.noise_channel.length_counter.enabled();
                                if ui.checkbox(&mut enabled, "Enabled").changed() {
                                    nes.system_mut()
                                        .apu
                                        .noise_channel
                                ...
                                egui::Grid::new("apu_noise_props").show(ui, |_ui| {});
                            });
                        });
                        ...
                        strip.cell(|ui| {
                            ...
                            ui.vertical(|ui| {
                                ...
                                ui.toggle_value(
                                    &mut nes.system_mut().apu.mixer.dmc_muted,
                                    "DMC Mute",
                                );
                                ui.checkbox(
                                    &mut nes.system_mut().apu.dmc_channel.loop_flag,
                                    "Loop",
                                );
                                ui.checkbox(
                                    &mut nes.system_mut().apu.dmc_channel.interrupt_enable,
                                    "IRQ Enabled",
                                );
                                egui::Grid::new("apu_dmc_props").show(ui, |_ui| {});
                            });
                        });
                        //ui.end_row();
                    });
