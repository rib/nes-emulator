            ...
            .show(ctx, |ui| {
                 ...
                 egui::SidePanel::left("memview_options_panel").show_inside(ui, |ui| {
                    egui::ComboBox::from_label("address_space")
                        ...
                        .show_ui(ui, |ui| {
                            ui.selectable_value(&mut self.selected_space, AddressSpace::System, "System Bus");
                            ui.selectable_value(&mut self.selected_space, AddressSpace::Ppu, "PPU Bus");
                            ui.selectable_value(&mut self.selected_space, AddressSpace::Oam, "OAM Memory");
                        }
                    );
                });
